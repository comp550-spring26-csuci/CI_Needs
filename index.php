...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .btn-secondary { background: white; color: var(--blue); border: 2px solid var(--blue); padding: 11px 28px; border-radius: 4px; font-size: 0.95rem; font-weight: 600; cursor: pointer; text-decoration: none; transition: all 0.2s; font-family: 'Source Sans 3', sans-serif; }
    ...
    .ann-item { font-size: 0.85rem; color: var(--blue); text-decoration: none; }
    ...
    .filter-btn { background: var(--white); border: 1.5px solid var(--light-gray); color: var(--text); padding: 6px 16px; border-radius: 20px; font-size: 0.85rem; font-weight: 600; cursor: pointer; transition: all 0.2s; font-family: 'Source Sans 3', sans-serif; }
    ...
    .need-card-meta { display: flex; justify-content: space-between; align-items: center; font-size: 0.8rem; color: var(--mid-gray); }
...
<body>
  ...
  <div class="top-bar">
    <div class="inner">
      ...
      <a href="https://myci.csuci.edu/" target="_blank">myCI Login</a>
    </div>
  </div>
  ...
  <header>
    <div class="header-inner">
      ...
      <nav>
        ...
        <a href="#" class="btn-nav">Submit a Need</a>
      </nav>
    </div>
  </header>
  ...
  <div class="announcements-bar">
    <div class="inner">
      ...
      <a class="ann-item" href="https://www.csuci.edu/basicneeds/food-assistance.htm">Food Pantry hours extended through finals week — Mon/Wed/Fri 10am–3pm</a>
      <span class="ann-divider">|</span>
      <a class="ann-item" href="#">Emergency Housing Fund applications open through March 15</a>
      <span class="ann-divider">|</span>
      <a class="ann-item" href="#">Check Service Status</a>
    </div>
  </div>
  ...
  <div class="main-wrapper">
    ...
    <div>
      ...
      <div class="submit-panel">
        <h2 class="section-title">Post a Need</h2>
        ...
        <div class="form-group">
          <label>Title</label>
          <input type="text" placeholder="Brief title for your need" />
        </div>
        <div class="form-group">
          <label>Description</label>
          <textarea placeholder="Describe what you need and how someone can help..."></textarea>
        </div>
        <div class="form-group">
          <label>Contact (optional)</label>
          <input type="text" placeholder="CI email or preferred contact" />
        </div>
        <button class="form-submit">Submit Need</button>
      </div>
      ...
      <div class="sidebar-panel">
        ...
        <a class="resource-link" href="https://www.csuci.edu/basicneeds/food-assistance.htm" target="_blank">
          <div class="resource-icon"></div> Food Pantry
        </a>
    ...
    <div class="footer-inner">
      <div class="footer-grid">
        <div class="footer-brand">
          ...
          <p>A peer-to-peer student resource network built for the Dolphin community. Connecting students with needs to students who can help.</p>
        </div>
        ...
        <div class="footer-col">
          <h4>Resources</h4>
          <a href="https://www.csuci.edu/basicneeds/food-assistance.htm" target="_blank">Food Pantry</a>
